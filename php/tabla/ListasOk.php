...
<table  width="100%" cellspacing="0" border="1">
	...
	if ($limite>0) {
		$limit=$limite- 20;
		echo "<aside class=\"anterior\" onclick=\"ListasOk(".$limit.")\"><img src='../../img/anterior.png'></aside>";
	}else
	{
	...
	if ($limite<$total- 20) {
		$limit=$limite+ 20;
		echo "<aside class=\"siguiente\" onclick=\"ListasOk(".$limit.")\"><img src='../../img/siguiente.png'></aside>";
	}
	else{
