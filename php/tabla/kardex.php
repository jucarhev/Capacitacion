<table  width="100%" cellspacing="0" >
	...
	<tr>
		<td colspan="5">
			<div class="espacio">
				<form action="" method="post" onsubmit="kardexjd();return false">
					<input type="text" id="buscadorKARDEX" placeholder="Ingrese un numero de cobro" class="espacio1" list="Trabajador" onkeyUp="return ValNumero(this);" required>
